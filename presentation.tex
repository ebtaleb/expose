...
\item Manque de precision, perte d'informations
% code subit encore des transformations/optimisations, est expansé puis réduit
\item Valeurs disponibles au débug pas toujours cohérentes
\end{enumerate}
...
\begin{enumerate}
\item A ce stade, le binaire contient plus d'info...
%plus d'endroits ou poser un point d'arrêt
\item ...mais ces infos ne peuvent pas etre lues par LLDB
...
\item Récuperer type associé à une variable et affiche sa valeur
\end{enumerate}
}
