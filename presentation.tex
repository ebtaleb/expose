...
% (pblm : au niveau du backend, le code manipule peut ne plus rien a voir avec le code source d'origine) - si gen des info dbg a ce niveau)
...
Fichier .cmt : arbre syntaxique typé sérialisé
Ecriture dans le binaire
\begin{itemize}
\pro Plus pratique que un .cmt
